...
function AppPicker({ icon, items, selectedItem, placeholder, onSelectItem, ...otherProps }) {
        ...
        <>
            <TouchableWithoutFeedback onPress={() => setModalVisible(true)}>
                <View style={styles.container}>
                    ...
                    <AppText style={styles.text} {...otherProps}>{selectedItem ? selectedItem.label : placeholder}</AppText>
